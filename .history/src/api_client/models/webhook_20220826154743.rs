...
pub enum CallbackType{
    TransactionCreated(TransactionDetails),
    TransactionStatusUpdate(TransactionDetails),
    TransactionApprovalStatusUpdate(TransactionDetails),
    VaultAccountAdded,
...
impl CallbackType{
    async fn serialize(data: String) -> String{
