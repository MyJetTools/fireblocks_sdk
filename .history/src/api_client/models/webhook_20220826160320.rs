...
impl CallbackType{
    pub async fn serialize(data: &str){
        ...
        let data_struct = value.get("data").unwrap();

        match callback_type.as_str(){
            "TRANSACTION_CREATED" => println!("0"),
            "TRANSACTION_STATUS_UPDATED" => println!("0"),
            "TRANSACTION_APPROVAL_STATUS_UPDATED" => println!("0"),
            "VAULT_ACCOUNT_ADDED" => println!("0"),
            "VAULT_ACCOUNT_ASSET_ADDED" => println!("0"),
            "INTERNAL_WALLET_ASSET_ADDED" => println!("0"),
            "EXTERNAL_WALLET_ASSET_ADDED" => println!("0"),
