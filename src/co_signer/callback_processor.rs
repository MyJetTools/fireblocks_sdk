...
pub fn decrypt_request(request: &str, public_key: Vec<u8>) -> Result<CoSignerCallback, Error>{
...
pub fn encrypt_request(response: CoSignerCallbackResponse, private_key: Vec<u8>) -> Result<String, Error>{
